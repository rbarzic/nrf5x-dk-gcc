...
ifeq ($(SDK_STRUCT_SER_S130),yes)
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/common/struct_ser/s130/ble_struct_serialization.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/common/struct_ser/s130/ble_gattc_struct_serialization.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/common/struct_ser/s130/ble_gap_struct_serialization.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/common/struct_ser/s130/ble_gatts_struct_serialization.c
INC_PATHS += -I $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/common/struct_ser/s130
endif
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s110/serializers/ble_gap_evt_conn_param_update_request.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s110/serializers/ble_gap_scan_start.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s110/serializers/ble_user_mem_reply.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s110/serializers/app_ble_user_mem.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s110/serializers/ble_gap_connect.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s110/serializers/ble_gap_rssi_get.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s110/serializers/ble_gap_scan_stop.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s110/serializers/app_ble_gap_sec_keys.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s110/serializers/ble_gap_connect_cancel.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s110/serializers/ble_evt_user_mem_release.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s110/serializers/ble_gap_evt_sec_request.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s110/serializers/ble_gap_evt_adv_report.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s110/serializers/ble_gap_encrypt.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s110/serializers/ble_evt_user_mem_request.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s110/serializers/ble_gap_evt_scan_req_report.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s110/serializers/ble_gap_evt_conn_param_update_request.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s110/serializers/conn_ble_user_mem.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s110/serializers/ble_gap_scan_start.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s110/serializers/conn_ble_gap_sec_keys.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s110/serializers/ble_user_mem_reply.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s110/serializers/ble_gap_connect.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s110/serializers/ble_gap_rssi_get.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s110/serializers/ble_gap_scan_stop.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s110/serializers/ble_gap_connect_cancel.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s110/serializers/ble_evt_user_mem_release.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s110/serializers/ble_gap_evt_sec_request.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s110/serializers/ble_gap_evt_adv_report.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s110/serializers/ble_gap_encrypt.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s110/serializers/ble_evt_user_mem_request.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s110/serializers/ble_gap_evt_scan_req_report.c
...
ifeq ($(SDK_S130_MIDDLEWARE),yes)
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/middleware/app_mw_ble_l2cap.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/middleware/app_mw_ble_gap.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/middleware/app_mw_ble_gattc.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/middleware/app_mw_nrf_soc.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/middleware/app_mw_ble_gatts.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/middleware/app_mw_ble.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/middleware/conn_mw_ble.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/middleware/conn_mw_ble_l2cap.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/middleware/conn_mw_ble_gattc.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/middleware/conn_mw_nrf_soc.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/middleware/conn_mw_ble_gap.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/middleware/conn_mw_ble_gatts.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/middleware/conn_mw_items.c
INC_PATHS += -I $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/middleware
endif
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s120/serializers/ble_user_mem_reply.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s120/serializers/app_ble_user_mem.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s120/serializers/ble_gap_rssi_get.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s120/serializers/ble_enable.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s120/serializers/ble_evt_user_mem_release.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s120/serializers/ble_evt_user_mem_request.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s120/serializers/ble_gap_evt_scan_req_report.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s120/serializers/conn_ble_user_mem.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s120/serializers/ble_user_mem_reply.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s120/serializers/ble_gap_rssi_get.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s120/serializers/ble_opt_id_pre_decoder.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s120/serializers/ble_enable.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s120/serializers/ble_evt_user_mem_release.c
...
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s120/serializers/ble_evt_user_mem_request.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s120/serializers/ble_gap_evt_scan_req_report.c
...
ifeq ($(SDK_S130_SERIALIZERS),yes)
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_evt_conn_param_update_request.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gatts_evt_sys_attr_missing.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_tx_power_set.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_ppcp_set.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_rssi_start.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gatts_evt_hvc.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gatts_characteristic_add.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_l2cap_tx.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_evt_conn_param_update.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gattc_evt_hvx.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gatts_evt_write.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gatts_sys_attr_set.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_l2cap_cid_unregister.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_appearance_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_scan_start.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gattc_evt_read_rsp.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gatts_evt_sc_confirm.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gattc_relationships_discover.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_user_mem_reply.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_l2cap_evt_rx.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gattc_evt_char_vals_read_rsp.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_uuid_encode.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_device_name_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gattc_hv_confirm.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_evt_auth_status.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_opt_set.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/app_ble_user_mem.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_authenticate.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_opt_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_sec_info_reply.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gattc_read.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_connect.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_event.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_evt_tx_complete.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_address_set.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_evt_rssi_changed.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_adv_stop.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_rssi_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gatts_service_changed.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_scan_stop.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gattc_char_value_by_uuid_read.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gatts_service_add.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_auth_key_reply.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gattc_write.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_evt_disconnected.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_tx_buffer_count_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_enable.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gatts_value_set.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gatts_descriptor_add.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gatts_evt_timeout.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gattc_characteristics_discover.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_uuid_decode.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gattc_char_values_read.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gatts_value_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_conn_param_update.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_ppcp_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_uuid_vs_add.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gatts_rw_authorize_reply.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_address_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gatts_sys_attr_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/temp_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_evt_sec_info_request.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_conn_sec_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/app_ble_gap_sec_keys.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_evt_sec_params_request.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_connect_cancel.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_adv_start.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_evt_user_mem_release.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gatts_include_add.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gattc_evt_write_rsp.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_evt_sec_request.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_version_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_evt_conn_sec_update.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_evt_passkey_display.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_adv_data_set.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gatts_hvx.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_rssi_stop.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gattc_descriptors_discover.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gattc_evt_char_val_by_uuid_read_rsp.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_evt_adv_report.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_disconnect.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gattc_evt_desc_disc_rsp.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gatts_evt_rw_authorize_request.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_evt_timeout.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_device_name_set.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_appearance_set.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_encrypt.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_evt_connected.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gattc_primary_services_discover.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/power_system_off.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_evt_auth_key_request.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gattc_evt_char_disc_rsp.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gattc_evt_rel_disc_rsp.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_evt_user_mem_request.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_evt_scan_req_report.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gattc_evt_timeout.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gap_sec_params_reply.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_gattc_evt_prim_srvc_disc_rsp.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/application/codecs/s130/serializers/ble_l2cap_cid_register.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_evt_conn_param_update_request.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gatts_evt_sys_attr_missing.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_tx_power_set.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_ppcp_set.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_rssi_start.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gatts_evt_hvc.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gatts_characteristic_add.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_l2cap_tx.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_evt_conn_param_update.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gattc_evt_hvx.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/conn_ble_user_mem.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gatts_evt_write.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gatts_sys_attr_set.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_l2cap_cid_unregister.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_appearance_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_scan_start.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gattc_evt_read_rsp.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gatts_evt_sc_confirm.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gattc_relationships_discover.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/conn_ble_gap_sec_keys.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_user_mem_reply.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_l2cap_evt_rx.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gattc_evt_char_vals_read_rsp.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_uuid_encode.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_device_name_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gattc_hv_confirm.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_evt_auth_status.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_opt_set.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_authenticate.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_opt_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_sec_info_reply.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gattc_read.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_connect.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_event.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_evt_tx_complete.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_address_set.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_evt_rssi_changed.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_adv_stop.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_rssi_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gatts_service_changed.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_scan_stop.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gattc_char_value_by_uuid_read.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gatts_service_add.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_auth_key_reply.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_opt_id_pre_decoder.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gattc_write.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_evt_disconnected.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_tx_buffer_count_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_enable.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gatts_value_set.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gatts_descriptor_add.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gatts_evt_timeout.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gattc_characteristics_discover.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_uuid_decode.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gattc_char_values_read.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gatts_value_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_conn_param_update.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_ppcp_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_uuid_vs_add.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gatts_rw_authorize_reply.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_address_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gatts_sys_attr_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/temp_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_evt_sec_info_request.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_conn_sec_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_evt_sec_params_request.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_connect_cancel.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_adv_start.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_evt_user_mem_release.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gatts_include_add.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gattc_evt_write_rsp.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_evt_sec_request.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_version_get.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_evt_conn_sec_update.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_evt_passkey_display.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_adv_data_set.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gatts_hvx.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_rssi_stop.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gattc_descriptors_discover.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gattc_evt_char_val_by_uuid_read_rsp.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_evt_adv_report.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_disconnect.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gattc_evt_desc_disc_rsp.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gatts_evt_rw_authorize_request.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_evt_timeout.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_device_name_set.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_appearance_set.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_encrypt.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_evt_connected.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gattc_primary_services_discover.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/power_system_off.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_evt_auth_key_request.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gattc_evt_char_disc_rsp.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gattc_evt_rel_disc_rsp.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_evt_user_mem_request.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_evt_scan_req_report.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gattc_evt_timeout.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gap_sec_params_reply.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_gattc_evt_prim_srvc_disc_rsp.c
C_SOURCE_FILES += $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers/ble_l2cap_cid_register.c
INC_PATHS += -I $(SDK_INSTALL_DIR)/$(SDK_VERSION)/components/serialization/connectivity/codecs/s130/serializers
endif
